...
class RestaurantServices {
  ...
  Future<RestaurantModel> getRestaurantById({required String id}) => _firestore.collection(collection).doc(id.toString()).get().then((doc){
    return RestaurantModel.fromSnapshot(doc);
  });

  Future<List<RestaurantModel>> searchRestaurant({required String restaurantName}) {
